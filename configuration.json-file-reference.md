...
See [Configuring pure javascript projects](https://github.com/liferay/liferay-npm-build-tools/wiki/Configuring-pure-javascript-projects#configuration) for more information on where this file is used.
