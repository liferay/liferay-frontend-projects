...
- **Description**:
  Defines the maximum number of files to process in parallel to avoid `EMFILE` errors. See issue [#298](https://github.com/liferay/liferay-npm-build-tools/issues/298) for more information.
- **Category**: `.npmbundlerrc`
- **Type**: `number`
- **Default**: `128`
- **Example**:
...
> ⚠ This option is not valid since `2.7.0`. See [#298](https://github.com/liferay/liferay-npm-build-tools/issues/298) for more information.
