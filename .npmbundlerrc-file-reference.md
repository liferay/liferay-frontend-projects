...
- **Category**: `.npmbundlerrc`
  > ⚠ This option is deprecated. Use [`create-jar.features.js-extender`](#create-jar.features.js-extender) instead.
...
- **Description**:
  Defines the JSON file describing the configuration structure.
- **Category**: `.npmbundlerrc`
- **Type**: `string`
- **Default**:
  - `features/settings.json` if file exists
  - `undefined` otherwise
- **Example**:
...
- **Category**: `.npmbundlerrc`
  > ⚠ This option is deprecated. Use [`create-jar.features.web-context`](#create-jar.features.web-context) instead.
...
- **Description**:
  Controls whether to process each npm package sequentially or all in parallel. Setting this option to `true` may prevent `EMFILE` errors (especially on Windows).
- **Category**: `.npmbundlerrc`
- **Type**: `boolean`
- **Default**: `false`
- **Example**:
