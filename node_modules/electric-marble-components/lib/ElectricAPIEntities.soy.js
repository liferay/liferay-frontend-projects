...
exports.templates = exports.ElectricAPIEntities = undefined;
...
goog.loadModule(function (exports) {
  ...
  function $augments(opt_data, opt_ignored, opt_ijData) {
    ie_open('div', null, null, 'class', 'entity-augments');
    ...
    for (var augmentationIndex24 = 0; augmentationIndex24 < augmentationListLen24; augmentationIndex24++) {
      ...
      if (augmentationData24.link) {
        ie_open('a', null, null, 'href', '/api/' + augmentationData24.link + '.html');
  ...
  function $default(opt_data, opt_ignored, opt_ijData) {
    ie_open('div', null, null, 'class', 'entity-default');
    ie_open('span');
    itext('Default: ');
    ie_open('code');
  ...
  function $entity(opt_data, opt_ignored, opt_ijData) {
    ie_open('section', null, null, 'class', 'card entity', 'data-access', opt_data.entityData.access ? opt_data.entityData.access : 'public', 'id', opt_data.entityData.name);
    ...
    if (opt_data.entityData.description) {
      ie_open('div', null, null, 'class', 'entity-description');
  ...
  function $entityHeader(opt_data, opt_ignored, opt_ijData) {
    ie_open('div', null, null, 'class', 'entity-header');
    ...
    ie_open('a', null, null, 'class', 'entity-link', 'href', 'https://github.com/' + opt_data.project.user + '/' + opt_data.project.repo + '/tree/' + opt_data.project.ref + '/' + filePath__soy82);
  ...
  function $entityName(opt_data, opt_ignored, opt_ijData) {
    ie_open('h1', null, null, 'class', 'entity-name');
    ie_open('a', null, null, 'href', '#' + opt_data.entityData.name);
    if (opt_data.entityData.access) {
      ie_open('span', null, null, 'class', 'entity-access');
    ...
    if (opt_data.entityData.kind == 'function' || opt_data.entityData.name == 'constructor') {
      ...
      ie_open('span', null, null, 'class', 'entity-name-type');
      itext(':');
  ...
  function $members(opt_data, opt_ignored, opt_ijData) {
    ie_open('div', null, null, 'class', 'entity-members');
  ...
  function $params(opt_data, opt_ignored, opt_ijData) {
    ie_open('div', null, null, 'class', 'entity-params');
  ...
  function $returns(opt_data, opt_ignored, opt_ijData) {
    ie_open('div', null, null, 'class', 'entity-returns');
...
var ElectricAPIEntities = function (_Component) {
  _inherits(ElectricAPIEntities, _Component);

  function ElectricAPIEntities() {
    _classCallCheck(this, ElectricAPIEntities);

    return _possibleConstructorReturn(this, (ElectricAPIEntities.__proto__ || Object.getPrototypeOf(ElectricAPIEntities)).apply(this, arguments));
  }

  return ElectricAPIEntities;
}(_metalComponent2.default);

_metalSoy2.default.register(ElectricAPIEntities, templates);
exports.ElectricAPIEntities = ElectricAPIEntities;
