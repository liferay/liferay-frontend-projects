...
describe('Look and Feel Util functions', function() {
	...
	describe('getLookAndFeelJSON', function() {
	...
	describe('mergeLookAndFeelJSON', function() {
	...
	describe('readLookAndFeelXML', function() {
	...
	describe('_extractThemeElement', function() {
