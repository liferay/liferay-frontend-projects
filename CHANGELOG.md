...
- feat: teach `gulp extend` to accept a package URL (8.x) (#266) ([\#332](https://github.com/liferay/liferay-js-themes-toolkit/pull/332))
...
- feat: auto-deploy when starting `gulp watch` (8.x) (#291) ([\#301](https://github.com/liferay/liferay-js-themes-toolkit/pull/301))
- fix: failure to update after non-JS/CSS changes in watch mode (8.x) (#291) ([\#300](https://github.com/liferay/liferay-js-themes-toolkit/pull/300))
...
- Kill dead watch\_socket.js and gogo-shell code \(v9\) [\#212](https://github.com/liferay/liferay-js-themes-toolkit/pull/212) ([wincent](https://github.com/wincent))
- Kill dead watch\_socket.js and gogo-shell code [\#211](https://github.com/liferay/liferay-js-themes-toolkit/pull/211) ([wincent](https://github.com/wincent))
...
- Remove incomplete Liferay DXP and Portal CE 7.2 support from v8 of toolkit [\#206](https://github.com/liferay/liferay-js-themes-toolkit/pull/206) ([wincent](https://github.com/wincent))
...
- Upgrade task should warn about expected portlet\_header dynamic-include extension point [\#35](https://github.com/liferay/liferay-js-themes-toolkit/issues/35)
...
- Fixes \#35 - Adds warning if a portlet.ftl file is found and does not contain the portlet\_header extension point [\#54](https://github.com/liferay/liferay-js-themes-toolkit/pull/54) ([jbalsas](https://github.com/jbalsas))
