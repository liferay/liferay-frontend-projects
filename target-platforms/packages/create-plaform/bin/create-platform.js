...
const output = {
	...
	pkgJson: {
		...
		dependencies: {
			...
			'babel-preset-liferay-standard': '^2.25.0',
			'liferay-npm-bundler': '^2.25.0',
			'liferay-npm-bundler-loader-copy-loader': '^2.25.0',
			'liferay-npm-bundler-loader-babel-loader': '^2.25.0',
			'liferay-npm-bundler-plugin-exclude-imports': '^2.25.0',
			'liferay-npm-bundler-plugin-inject-imports-dependencies': '^2.25.0',
			'liferay-npm-bundler-plugin-inject-peer-dependencies': '^2.25.0',
			'liferay-npm-bundler-plugin-namespace-packages': '^2.25.0',
			'liferay-npm-bundler-plugin-replace-browser-modules': '^2.25.0',
			'liferay-npm-bundler-plugin-resolve-linked-dependencies': '^2.25.0',
		},
