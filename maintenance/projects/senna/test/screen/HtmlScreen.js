...
describe('HtmlScreen', function () {
	...
	it('does not force favicon to change whenever the href change when the browser is IE', (done) => {
	...
	it('mutates temporary style hrefs to be unique on ie browsers', (done) => {
