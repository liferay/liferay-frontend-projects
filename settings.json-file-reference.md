...
> 👀 You need to have [LPS-91044](https://issues.liferay.com/browse/LPS-91044) applied to your portal and [#270](https://github.com/liferay/liferay-npm-build-tools/issues/270) in the `liferay-npm-bundler` for this feature to work. Otherwise, the configuration will show up under `Platform` > `Third Party` in `System Settings`.
