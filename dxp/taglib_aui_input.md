...
| <code id="text-prefix">prefix</code>                   | See [Prefix Attribute](#prefix-attribute) section.                                                                                                                                                                                                                                        |
| <code id="text-readonly">readonly</code>               | Sets `readonly` attribute on input. Use `readonly="<%= true %>"`                                                                                                                                                                                                                          |
| <code id="text-suffix">suffix</code>                   | See [Suffix Attribute](#suffix-attribute) section.                                                                                                                                                                                                                                        |
